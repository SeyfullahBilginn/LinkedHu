...
function MeetingIcon({ color, size }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      <g id="Basic-Elements" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        >
          <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
            <g id="meeting" transform="translate(153.000000, 450.000000)">
              <path
...
// Setting default values for the props of Meetings
MeetingIcon.defaultProps = {
  color: "dark",
  size: "16px",
};

// Typechecking props for the Meetings
